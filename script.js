document.addEventListener("DOMContentLoaded", () => {
  ...
  /* 🎧 ÂM THANH LẬT TRANG (sửa thành link online) */
  const flipSound = new Audio(
    "https://cdn.pixabay.com/download/audio/2022/03/15/audio_9b6d9d8d6c.mp3?filename=page-flip-47177.mp3"
  );
  ...
  class Firework {
    constructor(delay = 0) {
      ...
      this.targetY =
        Math.random() * (canvas.height * 0.45) + canvas.height * 0.15;
